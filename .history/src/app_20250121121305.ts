...
const generateToken = (userId: number): string => {
  return jwt.sign({ userId }, 'JWT_SECRET=8b17f9a30f6dc65dbe3b1f9f89b3d4c6ed7b2e8421a4e42d2ff292720cbac12d', { expiresIn: '1h' });
};
...
app.get('/getuser', async (request, reply) => {
  ...
  try {
    const decoded = jwt.verify(token, 'JWT_SECRET=8b17f9a30f6dc65dbe3b1f9f89b3d4c6ed7b2e8421a4e42d2ff292720cbac12d') as { userId: number };
